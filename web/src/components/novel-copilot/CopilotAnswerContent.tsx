...
const mdClass = [
  'max-w-none text-[15px] leading-7 text-foreground/88',
  // block spacing
  '[&_p]:my-2 [&_p]:leading-7',
  '[&_h1]:mt-4 [&_h1]:mb-2 [&_h1]:text-lg [&_h1]:font-semibold [&_h1]:text-foreground/92',
  '[&_h2]:mt-3.5 [&_h2]:mb-1.5 [&_h2]:text-[15px] [&_h2]:font-semibold [&_h2]:text-foreground/92',
  '[&_h3]:mt-3 [&_h3]:mb-1.5 [&_h3]:text-[14px] [&_h3]:font-semibold [&_h3]:text-foreground/90',
  ...
  '[&_code]:rounded [&_code]:bg-foreground/6 [&_code]:px-1 [&_code]:py-0.5 [&_code]:text-[13px]',
  '[&_pre_code]:bg-transparent [&_pre_code]:p-0',
  '[&_a]:text-primary [&_a]:underline [&_a]:underline-offset-2',
  '[&_strong]:font-semibold [&_strong]:text-foreground/95',
  '[&_table]:my-2 [&_table]:w-full [&_table]:text-[13px]',
